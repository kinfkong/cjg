...
- (void) readerView: (ZBarReaderView*) _readerView
    ...
    NSURLRequest* urlrequest = [NSURLRequest requestWithURL:[NSURL URLWithString:[NSString stringWithFormat:@"http://ishelf.obanana.com/index.php/isbn/index/%@/%@", isbn, @"dali"]]];
